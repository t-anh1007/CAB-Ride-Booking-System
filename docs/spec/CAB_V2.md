...
3.  ![](images/media/image1.png){width="6.1263134295713035in"
    height="1.6557469378827647in"}**Kiến trúc tổng thể (Overall
    Architecture)**

    1.  **Kiến trúc tổng thể -- Microservices**

![](images/media/image2.png){width="6.523396762904637in"
...
4.  ![](images/media/image1.png){width="6.1263134295713035in"
...
![](images/media/image3.png){width="6.476416229221347in"
height="5.015624453193351in"}

5.  **Kiến trúc Real-time & Event-driven**

![](images/media/image4.png){width="6.2899814085739285in"
height="2.5375in"}
...
![](images/media/image5.png){width="5.177297681539808in"
...
7.  ![](images/media/image1.png){width="6.1263134295713035in"
    height="1.6557469378827647in"}**Kiến trúc mở rộng & chịu lỗi
    (Scalability & Resilience)**

![](images/media/image6.png){width="6.511476377952756in"
...
![](images/media/image7.png){width="6.52459208223972in"
height="5.2325in"}

Ứng dụng AI:

- ![](images/media/image1.png){width="6.1263134295713035in"
...
![](images/media/image8.jpeg){width="6.446120953630796in"
height="3.6225in"}

2.  **Login & Refresh Token**

![](images/media/image9.jpeg){width="6.496932414698163in"
...
![](images/media/image10.jpeg){width="6.549444444444444in"
...
![](images/media/image11.png){width="6.2713921697287835in"
...
![](images/media/image12.jpeg){width="6.55623687664042in"
height="5.92625in"}
...
- Cho phép mở rộng sang nhiều PSP (Stripe, VNPay, MoMo, ...)
  ...
  1.  ![](images/media/image1.png){width="6.1263134295713035in"
      height="1.6557469378827647in"}**Saga Pattern cho Payment (Hoàn
      chỉnh)**

![](images/media/image13.jpeg){width="6.5506583552055995in"
...
![](images/media/image14.png){width="6.223580489938757in"
...
![](images/media/image15.jpeg){width="5.9379844706911635in"
height="2.8525in"}
...
![](images/media/image16.png){width="6.4508541119860014in"
height="1.1229166666666666in"}

**9A.2.5 Mapping UI Components → React Structure**

![](images/media/image17.png){width="1.8752766841644795in"
...
![](images/media/image18.png){width="6.431446850393701in"
...
![](images/media/image19.png){width="6.454610673665792in"
...
![](images/media/image20.png){width="2.438591426071741in"
...
+===============================================================================+===============================================+
| ![](images/media/image21.png)Runtime | > Node.js (NestJS / Express)                  |
+-------------------------------------------------------------------------------+-----------------------------------------------+
...
| Validation                                                                    | > Zod / Joi                                   |
+-------------------------------------------------------------------------------+-----------------------------------------------+
| Microservices internal communication                                          | > Synchronous: request-response, like REST    |
|                                                                               | > API (HTTP/HTTPS), gRPC Asynchronous:        |
...
![](images/media/image22.png){width="3.376137357830271in"
height="3.04in"}

2.  **Sequence Diagram -- AI Matching**

![](images/media/image23.png){width="6.407702318460193in"
height="2.620311679790026in"}

3.  **Sequence Diagram -- Payment Saga**

![](images/media/image24.jpeg){width="4.849261811023622in"
...
![](images/media/image25.png){width="4.140777559055118in"
...
![](images/media/image26.png){width="2.0251760717410323in"
height="3.843228346456693in"}

2.  **Payment State Machine**

![](images/media/image27.jpeg){width="1.3676213910761155in"
